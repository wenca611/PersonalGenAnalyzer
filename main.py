...
https://web.archive.org/web/20160307034828/http://www.mvcr.cz/clanek/cetnost-jmen-a-prijmeni-722752.aspx?q=Y2hudW09MQ%3D%3D
"""
import pandas as pd
# import random
    ...
    def load_first_name(self, *files):
        ...
        for file in files:
            ...
            if 'Name' in df.columns:
                all_names.append(df[['Name']])
            else:
                print(f"Warning: 'Name' column not found in {file}.")

        self.data = pd.concat(all_names, ignore_index=True)


    def load_last_name(self, file):
        pass

if __name__ == "__main__":
    processor = DataProcessor()
    processor.load_first_name("Seznam_muzskych_jmen_-_20240731")